...
import { CelestialBody } from '../../app/rendering/drawing-manager/celestial-bodies/celestial-body';
import { DwarfPlanet } from '../../app/rendering/drawing-manager/celestial-bodies/dwarf-planet';
import { Jupiter } from '../../app/rendering/drawing-manager/celestial-bodies/jupiter';
import { Makemake } from '../../app/rendering/drawing-manager/celestial-bodies/makemake';
import { Mars } from '../../app/rendering/drawing-manager/celestial-bodies/mars';
import { Mercury } from '../../app/rendering/drawing-manager/celestial-bodies/mercury';
import { Moon } from '../../app/rendering/drawing-manager/celestial-bodies/moon';
import { Neptune } from '../../app/rendering/drawing-manager/celestial-bodies/neptune';
import { Pluto } from '../../app/rendering/drawing-manager/celestial-bodies/pluto';
import { Saturn } from '../../app/rendering/drawing-manager/celestial-bodies/saturn';
import { Uranus } from '../../app/rendering/drawing-manager/celestial-bodies/uranus';
import { Venus } from '../../app/rendering/drawing-manager/celestial-bodies/venus';
import { Earth } from '../../app/rendering/drawing-manager/earth';
import { AtmosphereSettings } from '../../app/rendering/drawing-manager/earth-quality-enums';
